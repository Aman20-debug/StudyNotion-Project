...
const Catalog = () => {
  ...
  // Fetch all categories and match the current catalogName
  useEffect(() => {
  ...
  useEffect(() => {
    const getCategoryDetails = async () => {
      try {
        console.log("Sending categoryId from Catalog Page", categoryId)
        const res = await getCatalogaPageData(categoryId)
        console.log("Received Catalog Page Data: ", res)
  ...
  console.log("Slider Courses", catalogPageData?.data?.selectedCategory?.course);
  ...
  return (
    <>
      ...
      {/* Section 2: Other Category Top Courses */}
      <div className="mx-auto box-content w-full max-w-maxContentTab px-4 py-12 lg:max-w-maxContent">
